...
(
    id_enseignant CHAR(9) PRIMARY KEY REFERENCES personnes(id_personne),
    fk_dep        CHAR(9) REFERENCES departements(id_dep)
);

CREATE TABLE etudiants
(
    id_etudiant CHAR(9) PRIMARY KEY REFERENCES personnes(id_personne),
...
(
    id_user     CHAR(9) PRIMARY KEY REFERENCES personnes(id_personne),
...
INSERT INTO departements VALUES ('D0001', 'Informatique');
INSERT INTO classes VALUES ('C0001', 'Licence 3 Informatique', 'D0001');
INSERT INTO groupes VALUES ('G0001', 'Groupe A', 'C0001');

-- Données Salles & Lecteurs IoT
INSERT INTO salles VALUES ('S0001', 'Salle Reseau 101', 30, 'reseau', 'normal');
INSERT INTO lecteurs VALUES ('L0001', 'fonctionel', 'S0001');

-- Données Personnes & Étudiants (Jean Dupont)
INSERT INTO personnes VALUES ('2202100b', 'Dupont', 'Jean', '2002-01-01', 'jean.dupont@test.fr', '0600000000', 'homme');
INSERT INTO etudiants VALUES ('2202100b', '2202100b', 'C0001');
INSERT INTO appartenir_groupe VALUES ('2202100b', 'G0001');

-- Données Personnes & Enseignants (Marc Martin)
INSERT INTO personnes VALUES (id_personne 'E00000001', 'Martin', 'Marc', '1975-05-12', 'marc.martin@univ.fr', '0611223344', 'homme');
INSERT INTO enseignants VALUES ('E00000001', 'D0001');

-- Données Cours
INSERT INTO cours VALUES ('C00002', CURRENT_DATE, '08:00:00', '12:00:00', 'S0001');
INSERT INTO enseigner VALUES ('E00000001', 'C00002');

-- Donnée de Présence Initiale (Déjà badgé)
INSERT INTO assister VALUES ('2202100b', 'C00002', 'present', NULL, '09:00:00');
